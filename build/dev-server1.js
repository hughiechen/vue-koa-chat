...
// app.get('http://huang.iiio.top/addons/sz_yi/template/mobile/style1/member/teamchat.html#/chat', function (req, res) {
//   connection.query('select * from hs_account', function(err, rows, fields) {
//     if (err) throw err;
//     console.log(rows);
//     res.send(rows);
//     connection.end();
